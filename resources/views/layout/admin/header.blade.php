						...
						<ul class="nav navbar-nav navbar-right tooltip-area">
								...
								<li class="dropdown">
										...
										<ul class="dropdown-menu pull-right icon-right arrow">
												...
												<li><a href="bookmarks"><i class="fa fa-bookmark"></i> Bookmarks</a></li>
												<li><a href="deposit"><i class="fa fa-money"></i> Make a Deposit</a></li>
												<li class="divider"></li>
												<li><a href="signout"><i class="fa fa-sign-out"></i> Signout </a></li>
										</ul>
										<!-- //dropdown-menu-->
								</li>
								<li class="visible-lg">
