...
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset("/core/front/assets/ico/apple-touch-icon-144-precomposed.png") }}">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ asset("/core/front/assets/ico/apple-touch-icon-114-precomposed.png") }}">
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ asset("/core/front/assets/ico/apple-touch-icon-72-precomposed.png") }}">
<link rel="apple-touch-icon-precomposed" href="{{ asset("/core/front/assets/ico/apple-touch-icon-57-precomposed.png") }}">
<link rel="shortcut icon" href="assets/ico/favicon.ico">
<!-- CSS Stylesheet-->
<link type="text/css" rel="stylesheet" href="{{ asset("/core/front/assets/css/bootstrap/bootstrap.min.css") }}" />
<link type="text/css" rel="stylesheet" href="{{ asset("/core/front/assets/css/bootstrap/bootstrap-themes.css") }}" />
<link type="text/css" rel="stylesheet" href="{{ asset("/core/front/assets/css/style.css") }}" />

<!-- Styleswitch if  you don't chang theme , you can delete -->
<link type="text/css" rel="alternate stylesheet" media="screen" title="style1" href="{{ asset("/core/front/assets/css/styleTheme1.css") }}" />
<link type="text/css" rel="alternate stylesheet" media="screen" title="style2" href="{{ asset("/core/front/assets/css/styleTheme2.css") }}" />
<link type="text/css" rel="alternate stylesheet" media="screen" title="style3" href="{{ asset("/core/front/assets/css/styleTheme3.css") }}" />
<link type="text/css" rel="alternate stylesheet" media="screen" title="style4" href="{{ asset("/core/front/assets/css/styleTheme4.css") }}" />
						...
						<nav class="navbar" role="navigation">
								<div class="container">
										...
										<ul class="nav navbar-nav navbar-right hidden-xs" id="navigation">
												...
												<li class="dropdown">
														<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Features &nbsp; <i class="fa fa-angle-down"></i></a>
												...
												<li><a href="element.html">Shortcodes</a></li>
...
<!-- Jquery Library -->
<script type="text/javascript" src="{{ asset("/core/front/assets/js/jquery.min.js") }}"></script>
<script type="text/javascript" src="{{ asset("/core/front/assets/js/jquery.ui.min.js") }}"></script>
<script type="text/javascript" src="{{ asset("/core/front/assets/plugins/bootstrap/bootstrap.min.js") }}"></script>
<!-- Modernizr Library For HTML5 And CSS3 -->
<script type="text/javascript" src="{{ asset("/core/front/assets/js/modernizr/modernizr.js") }}"></script>
<!-- Owl Carousel  -->
<script type="text/javascript" src="{{ asset("/core/front/assets/plugins/owl-carousel/owl.carousel.js") }}"></script>
<link href="{{ asset("/core/front/assets/plugins/owl-carousel/owl.carousel.css") }}" rel="stylesheet">
<link href="{{ asset("/core/front/assets/plugins/owl-carousel/owl.theme.css") }}" rel="stylesheet">
<link href="{{ asset("/core/front/assets/plugins/owl-carousel/owl.transitions.css") }}" rel="stylesheet">
<!-- Revolution Slide -->
<script type="text/javascript" src="{{ asset("/core/front/assets/plugins/slide/js/jquery.themepunch.plugins.min.js") }}"></script>
<script type="text/javascript" src="{{ asset("/core/front/assets/plugins/slide/js/jquery.themepunch.revolution.min.js") }}"></script>
<link rel="stylesheet" type="text/css" href="{{ asset("/core/front/assets/plugins/slide/css/settings.css") }}" media="screen" />
<!-- Select Nav -->
<script type="text/javascript" src="{{ asset("/core/front/assets/plugins/selectnav/selectnav.min.js") }}"></script>
<!-- Fancybox plugin -->
<script type="text/javascript" src="{{ asset("/core/front/assets/plugins/fancybox/jquery.fancybox.js") }}"></script>	
<link href="{{ asset("/core/front/assets/plugins/fancybox/jquery.fancybox.css") }}" rel="stylesheet" />
<!-- Library Themes Customize-->
<script type="text/javascript" src="{{ asset("/core/front/assets/js/caplet.custom.js") }}"></script>
